    ...
    def __init__(self, l):
        ...
        self.transform = transforms.Compose([
            ...
            transforms.RandomApply([transforms.GaussianBlur(kernel_size = int(l//10) if int(l//10)%2!=0 else int(l//10)+1, 
                                                            sigma=(0.8,2.0))],
                                   p=0.1),
            transforms.RandomSolarize(threshold = 0.8, p=0.0)
        ])
        self.transform_prime = transforms.Compose([
            ...
            transforms.RandomApply([transforms.GaussianBlur(kernel_size = int(l//10) if int(l//10)%2!=0 else int(l//10)+1, 
                                                            sigma=(0.8,2.0))],
                                   p=0.1),
            transforms.RandomSolarize(threshold = 0.7, p=0.2)
        ])
    ...
    def __init__(self,l):
        ...
        self.transform = transforms.Compose([
            ...
            transforms.RandomApply([transforms.GaussianBlur(kernel_size = int(l//10) if int(l//10)%2!=0 else int(l//10)+1, 
                                                            sigma=(0.8,2.0))],
                                   p=0.5),
            transforms.RandomSolarize(threshold = 0.7, p=0.1)
        ])
...
class DSTransforms:
    def __init__(self,l):
        self.l = l
        self.transform = transforms.Compose([transforms.RandomResizedCrop(self.l,(0.8,1.0)),
                                             transforms.RandomHorizontalFlip(p=0.5)])
